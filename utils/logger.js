...
if (LOG_FILE_ENABLED === false) {
  setLoggerConfig({ file: { enabled: false, path: null } });
} else if (typeof LOG_FILE_PATH === 'string' && LOG_FILE_PATH.length > 0) {
  setLoggerConfig({ file: { enabled: true, path: LOG_FILE_PATH } });
}
